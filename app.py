...
def _build_app() -> gr.TabbedInterface:
    band_iface = gr.Interface(
        ...
        inputs=[
            ...
            gr.Dropdown(label="Device", choices=["auto", "cpu", "cuda"], value="auto"),
            gr.Number(label="Seed (optional)", value=None, precision=0),
            gr.Textbox(label="Model ID (optional)", value=""),
            gr.Number(label="top_k (optional)", value=None, precision=0),
            gr.Number(label="top_p (optional)", value=None),
            gr.Number(label="temperature (optional)", value=None),
            gr.Number(label="no_repeat_ngram_size (optional)", value=None, precision=0),
            gr.Number(label="max_length (optional)", value=None, precision=0),
        ],
